    ...
    render(){
        ...
        if (this.state.showPullStatus===ShowLoadingStatus.SHOW_DOWN){
            indicatorView=<Image
                ...
                source={require('../resources/imgs/ic_refresh_sunny.png')}
        ...
        return (
            <View style={styles.base}>
                <View style={{position:'absolute'}}>
                    <ImageBackground style={{height: self.state.currentDistance, width: deviceWidth}} source={require('../resources/imgs/ic_refresh_sun.jpg')} resizeMode='cover'>
                    <View style={{justifyContent:'center',alignItems:'center',width:deviceWidth,height:self.state.currentDistance,flexDirection:'row'}}>
                        {indicatorView}
                        <View style={{height:self.state.currentDistance,justifyContent:'center',alignItems:'center',marginLeft:10}}>
